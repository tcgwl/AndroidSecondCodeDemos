...
public class ChooseAreaFragment extends BaseFragment {
    ...
    private void queryProvices() {
        ...
        if (provinceList.size() > 0) {
            ...
            String address = Constant.CHINA_URL;
    ...
    private void queryCities() {
        ...
        if (cityList.size() > 0) {
            ...
            String address = Constant.CHINA_URL + "/" + provinceCode;
    ...
    private void queryCounties() {
        ...
        if (countyList.size() > 0) {
            ...
            String address = Constant.CHINA_URL + "/" + provinceCode + "/" + cityCode;
        ...
        HttpUtil.sendOkHttpRequest(address, new okhttp3.Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                ...
                UIUtils.postTaskSafely(() -> {
                    closeProgressDialog();
                    CustomToast.showShort(UIUtils.getContext(), "加载失败");
                });
            }
